<template>
    <Menu as="div" class="relative block text-left">
        ...
        <transition enter-active-class="transition duration-100 ease-out"
            ...
            <MenuItems
                class="absolute left-0 mt-2 w-32 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div class="px-1 py-1">
